...
name = '_data_'
for i in range(1):
    np.save("../10_fold_corpus/train_dev_X", train_X[i])
    np.save("../10_fold_corpus/train_dev_Y", train_Y[i])
    np.save("../10_fold_corpus/test_X", test_X[i])
    np.save("../10_fold_corpus/test_Y", test_Y[i])
